...
describe 'nomad class' do
  context 'default parameters' do
    ...
    describe file('/var/lib/nomad') && file('/opt/puppet-archive/nomad-1.9.3') do
      it { is_expected.to be_directory }
    end

    describe file('/opt/puppet-archive/nomad-1.9.3/nomad') do
      it { is_expected.to be_file }
    end

    describe file('/usr/bin/nomad') do
      it { is_expected.to be_symlink }
      it { is_expected.to be_linked_to '/opt/puppet-archive/nomad-1.9.3/nomad' }
    end
